...
func TestValidate(t *testing.T) {
	testCases := []struct {
		...
		{name: "Test a cpf with less than eleven digits", cpf: CPF("121212121212"), expected: false},
		{name: "Test a cpf with more than eleven digits", cpf: CPF("1010101010"), expected: false},
		{name: "Test with blank cpf", cpf: CPF(""), expected: false},
	}
